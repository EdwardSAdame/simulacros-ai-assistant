...
* **Figure Size & Resolution**: You MUST set the figure size to (Landscape) and the DPI to 300. Initialize the plot exactly using `fig, ax = plt.subplots(figsize=(10, 6), dpi=300)`.
