...
def get_flashcard_system_prompt(topic: str, num_questions: int) -> str:
    ...
    return (
        ...
        "1. **Image Prompt (Background)**: You MUST generate an `image_prompt` that conceptualizes a highly descriptive, concrete scene representing the academic topic. Describe tangible objects, landscapes, or environments. The scene MUST be explicitly described as an Impressionist painting (style of Claude Monet). The composition MUST NOT include any text, letters, formulas, or numbers.\n"
