...
def get_flashcard_system_prompt(topic: str, num_questions: int) -> str:
    ...
    return (
        ...
        "1. **Question Design (Front)**: The 'front' MUST contain a highly specific, direct factual question or a fill-in-the-blank statement. DO NOT ask complex, comparative, or open-ended questions. The question must naturally resolve to a single specific term, name, or very short concept.\n"
        ...
        "3. **Micro-Answers (Back)**: The 'back' field MUST be extremely concise. It should ideally be 1 to 3 words. Under no circumstances should it exceed a short, single sentence. This is for rapid recall memorization.\n"
