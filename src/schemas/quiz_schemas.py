...
class QuizQuestion(BaseModel):
    ...
    # -------------------------------------------------------------------------
    # CAMBIO CRÍTICO: Movemos 'explanation' (o 'reasoning') ARRIBA.
    # Esto fuerza "Chain of Thought" antes de generar las opciones.
    # -------------------------------------------------------------------------
    explanation: str = Field(..., description="Step-by-step solution. YOU MUST SOLVE THE PROBLEM HERE FIRST before generating options.")
    ...
    # Nota: He movido 'explanation' arriba, así que lo eliminamos de aquí abajo.
