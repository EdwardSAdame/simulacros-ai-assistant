...
def build_runtime_context(
    ...
    user subscription status, and strict exam lockdowns.
    """
    try:
        ...
        # --- 🟢 6. ANTI-CHEAT LOCKDOWN INJECTION 🟢 ---
        if exam_state == "ACTIVE":
            signals.append(
                ...
                "estaré encantada de explicarte cualquier pregunta detalladamente. ¡Buena suerte!'"
            )
        # ----------------------------------------------
