...
class QuizService:
    ...
    def get_system_instruction() -> Dict[str, Any]:
        ...
        instruction_text = (
            ...
            "3. **Descriptive Titles**: The `question_title` MUST be a short, 3-5 word summary of the specific topic, formatted in Markdown Bold.\n"
            "   - Bad: \"Question 1\"\n"
            "   - Good: \"**Balancing Redox Equations**\" or \"**Calculus: Limits**\"\n\n"
